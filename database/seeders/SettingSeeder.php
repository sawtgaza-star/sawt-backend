    ...
    public function run(): void
    {
        $settings = [
            ...
            ['group' => 'home', 'key' => 'home_platform_sections', 'value' => json_encode([
                ['image' => '', 'icon' => '', 'title_ar' => 'منصة صوت', 'title_en' => 'Sawt Platform', 'desc_ar' => '', 'desc_en' => '', 'stat1_ar' => '+30 مليون مشاهدة', 'stat1_en' => '+30 million views', 'stat2_ar' => '+100 مقطع', 'stat2_en' => '+100 clips', 'cta_ar' => 'اقرأ المزيد', 'cta_en' => 'Read more'],
                ['image' => '', 'icon' => '', 'title_ar' => 'حاضنة صوت', 'title_en' => 'Sawt Incubator', 'desc_ar' => '', 'desc_en' => '', 'stat1_ar' => '+100 متدرب', 'stat1_en' => '+100 trainees', 'stat2_ar' => '+10 مشاريع', 'stat2_en' => '+10 projects', 'cta_ar' => 'اقرأ المزيد', 'cta_en' => 'Read more'],
                ['image' => '', 'icon' => '', 'title_ar' => 'صوت ميديا', 'title_en' => 'Sawt Media', 'desc_ar' => '', 'desc_en' => '', 'stat1_ar' => '+500 محتوى إبداعي', 'stat1_en' => '+500 creative pieces', 'stat2_ar' => '+100 عميل', 'stat2_en' => '+100 clients', 'cta_ar' => 'اقرأ المزيد', 'cta_en' => 'Read more'],
            ], JSON_UNESCAPED_UNICODE), 'type' => 'json'],
            ...
            ['group' => 'home', 'key' => 'home_stories_limit', 'value' => '4', 'type' => 'number'],
            ...
            ['group' => 'stories', 'key' => 'story_hero_title_ar', 'value' => 'قصص النجاح', 'type' => 'string'],
            ['group' => 'stories', 'key' => 'story_hero_title_en', 'value' => 'Success Stories', 'type' => 'string'],
            ['group' => 'stories', 'key' => 'story_hero_desc_ar', 'value' => 'قصص حقيقية من غزة نقلتها منصة صوت إلى العالم', 'type' => 'text'],
            ['group' => 'stories', 'key' => 'story_hero_desc_en', 'value' => 'Real stories from Gaza carried by Sawt to the world', 'type' => 'text'],
            ['group' => 'stories', 'key' => 'story_related_title_ar', 'value' => 'قصص ذات صلة', 'type' => 'string'],
            ['group' => 'stories', 'key' => 'story_related_title_en', 'value' => 'Related stories', 'type' => 'string'],
            ['group' => 'stories', 'key' => 'story_related_subtitle_ar', 'value' => 'قصص حقيقية من غزة نقلتها منصة صوت إلى العالم', 'type' => 'text'],
            ['group' => 'stories', 'key' => 'story_related_subtitle_en', 'value' => 'Real stories from Gaza carried by Sawt to the world', 'type' => 'text'],
            ['group' => 'stories', 'key' => 'story_view_all_ar', 'value' => 'عرض جميع القصص', 'type' => 'string'],
            ['group' => 'stories', 'key' => 'story_view_all_en', 'value' => 'View all stories', 'type' => 'string'],
            ['group' => 'collaborate', 'key' => 'collaborate_hero_title_ar', 'value' => 'تعاون معنا', 'type' => 'string'],
