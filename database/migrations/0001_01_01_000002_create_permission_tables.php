...
/**
 * هذا هو الشكل الرسمي لجداول حزمة spatie/laravel-permission.
 *
 * ليش استبدلنا التصميم القديم (roles/permissions/model_has_permissions فقط)؟
 * - كان ناقص جدول model_has_roles (ربط اليوزر بالأدوار) وجدول role_has_permissions
 *   (ربط الأدوار بالصلاحيات مباشرة)، وبدونهم الحزمة ما تشتغل.
 * - عمود roles_id بجدول users كان يحصر اليوزر بدور واحد بس؛ Spatie بيسمح
 *   بأكثر من دور لنفس اليوزر (مثلاً: admin + content_moderator مع بعض).
 * - استخدام الحزمة الجاهزة هو المطلوب فعلياً عشان Filament Shield يشتغل عليها.
 */
